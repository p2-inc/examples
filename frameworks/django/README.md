> :rocket: Fork of [Mozilla Django example](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django) demonstrating using Keycloak authentication for Django web apps. See the article on our blog: [Django Web Authentication With Keycloak](https://phasetwo.io/blog/secure-django)
