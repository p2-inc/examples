 ...
 * 
 * @export
 * @interface PortalLinkRepresentation
 */
export interface PortalLinkRepresentation {
    /**
     * 
     * @type {string}
     * @memberof PortalLinkRepresentation
     */
    user?: string;
    /**
     * 
...
/**
 * Check if a given object implements the PortalLinkRepresentation interface.
 */
export function instanceOfPortalLinkRepresentation(value: object): value is PortalLinkRepresentation {
    return true;
}

export function PortalLinkRepresentationFromJSON(json: any): PortalLinkRepresentation {
    return PortalLinkRepresentationFromJSONTyped(json, false);
}

export function PortalLinkRepresentationFromJSONTyped(json: any, ignoreDiscriminator: boolean): PortalLinkRepresentation {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function PortalLinkRepresentationToJSON(json: any): PortalLinkRepresentation {
      return PortalLinkRepresentationToJSONTyped(json, false);
  }

  export function PortalLinkRepresentationToJSONTyped(value?: PortalLinkRepresentation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
