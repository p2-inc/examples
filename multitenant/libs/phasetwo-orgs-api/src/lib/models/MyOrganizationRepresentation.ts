 ...
 * 
 * @export
 * @interface MyOrganizationRepresentation
 */
export interface MyOrganizationRepresentation {
    /**
     * 
     * @type {string}
     * @memberof MyOrganizationRepresentation
     */
    name?: string;
    /**
     * 
...
/**
 * Check if a given object implements the MyOrganizationRepresentation interface.
 */
export function instanceOfMyOrganizationRepresentation(value: object): value is MyOrganizationRepresentation {
    return true;
}

export function MyOrganizationRepresentationFromJSON(json: any): MyOrganizationRepresentation {
    return MyOrganizationRepresentationFromJSONTyped(json, false);
}

export function MyOrganizationRepresentationFromJSONTyped(json: any, ignoreDiscriminator: boolean): MyOrganizationRepresentation {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function MyOrganizationRepresentationToJSON(json: any): MyOrganizationRepresentation {
      return MyOrganizationRepresentationToJSONTyped(json, false);
  }

  export function MyOrganizationRepresentationToJSONTyped(value?: MyOrganizationRepresentation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
