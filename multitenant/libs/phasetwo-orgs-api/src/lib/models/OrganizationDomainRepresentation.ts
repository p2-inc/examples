 ...
 */
export function instanceOfOrganizationDomainRepresentation(value: object): value is OrganizationDomainRepresentation {
    return true;
}
...
export function OrganizationDomainRepresentationFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrganizationDomainRepresentation {
    ...
    return {
        ...
        'recordKey': json['record_key'] == null ? undefined : json['record_key'],
        'recordValue': json['record_value'] == null ? undefined : json['record_value'],
        'type': json['type'] == null ? undefined : json['type'],
    };
}

  export function OrganizationDomainRepresentationToJSON(json: any): OrganizationDomainRepresentation {
      return OrganizationDomainRepresentationToJSONTyped(json, false);
  }

  export function OrganizationDomainRepresentationToJSONTyped(value?: OrganizationDomainRepresentation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
