 ...
 * 
 * @export
 * @interface RealmAttributeRepresentation
 */
export interface RealmAttributeRepresentation {
    /**
     * 
     * @type {string}
     * @memberof RealmAttributeRepresentation
     */
    name?: string;
    /**
     * 
...
/**
 * Check if a given object implements the RealmAttributeRepresentation interface.
 */
export function instanceOfRealmAttributeRepresentation(value: object): value is RealmAttributeRepresentation {
    return true;
}

export function RealmAttributeRepresentationFromJSON(json: any): RealmAttributeRepresentation {
    return RealmAttributeRepresentationFromJSONTyped(json, false);
}

export function RealmAttributeRepresentationFromJSONTyped(json: any, ignoreDiscriminator: boolean): RealmAttributeRepresentation {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function RealmAttributeRepresentationToJSON(json: any): RealmAttributeRepresentation {
      return RealmAttributeRepresentationToJSONTyped(json, false);
  }

  export function RealmAttributeRepresentationToJSONTyped(value?: RealmAttributeRepresentation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
